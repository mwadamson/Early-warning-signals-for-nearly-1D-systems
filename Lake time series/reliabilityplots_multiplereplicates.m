...
fileName = 'LakePhosphorousCalibWindowError_pt5pctNoise_multiple.mat';
load(fileName)
...
xlabel('Calibration window length', 'fontsize', 14, 'fontweight', 'bold');
ylabel('Proportion of predictions within tolerance', 'fontsize', 14, 'fontweight', 'bold');
...
xlabel('Calibration window start time', 'fontsize', 14, 'fontweight', 'bold');
ylabel('Proportion of predictions within tolerance', 'fontsize', 14, 'fontweight', 'bold');
