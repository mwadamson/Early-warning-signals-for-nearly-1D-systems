...
fileNames = {'fisherycalibrationwindow1pctnoisemultiple.mat', 'fisherycalibrationwindow2pctnoisemultiple.mat', 'fisherycalibrationwindow3pctnoisemultiple.mat'};
LineStyles = {'-', '--', ':'};
...
for iFile = 1:length(fileNames)
    ...
    maxWindowTime = round(0.95 * overallEarliestTransitionTime / 100) * 100;
    if maxWindowTime > overallEarliestTransitionTime
        maxWindowTime = floor(0.95 * overallEarliestTransitionTime / 100) * 100;
    end
    ...
    windowLength_windowLengthMax = 1500;
...
subplot(1, 2, 1)
legend('\sigma = 1%', '\sigma = 2%', '\sigma = 3%', 'Location', 'northwest')
subplot(1, 2, 2)
legend('\sigma = 1%', '\sigma = 2%', '\sigma = 3%', 'Location', 'northwest')